        ...
        <div className="space-y-10">
          ...
          >
            ...
            <p className="text-gray-700 dark:text-gray-400">
              <span className="font-medium text-gray-900 dark:text-white">Technologies Used:</span> Django,
          ...
          <motion.div
            className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-sm dark:shadow-gray-900 border-l-4 border-yellow-500"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <p className="text-gray-700 dark:text-gray-400">
              <span className="font-medium text-gray-900 dark:text-white">Tools & Technologies:</span> Python,
              Jupyter Notebook
            </p>
          </motion.div>
          ...
          {/* Earth 5R Internship */}
          <motion.div
            className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-sm dark:shadow-gray-900 border-l-4 border-green-500"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <p className="text-gray-700 dark:text-gray-400">
              <span className="font-medium text-gray-900 dark:text-white">Tools Used:</span> Earth 5R
